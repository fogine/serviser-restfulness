 ...
 * @return {Boolean}
 */
Resource.prototype.hasAssociation = function(resource) {
    if (resource === undefined) {
        return _.isEmpty(this._associations) ? false : true;
    } else if (resource instanceof Resource) {
        return this._associations.hasOwnProperty(resource.getPluralName());
    } else if (typeof resource === 'string') {
        return this._associations.hasOwnProperty(resource);
    } else {
...
Resource.prototype.hasMany = function(resource, options) {
    ...
    resource._associations[this.getPluralName()] = {
        type: '1xM', //even more exact would be Mx1 although not needed currently
        foreignKey: options.localKey,
        localKey: options.foreignKey
    };
};
