...
function getOneViaSingleResourceQuery(req, res) {
    ...
    return query
        ...
        .then(_getOneResponse(res, resource, embed));
}
...
function getOneViaOneToOneQuery(req, res) {
    ...
    return query
        .catch(routeUtils._transformKnexError)
        .then(_getOneResponse(res, secondResource, embed));
}
...
function getOneViaOneToManyQuery(req, res) {
    ...
    return query
        .catch(routeUtils._transformKnexError)
        .then(_getOneResponse(res, lastResource, embed));
}
...
function getManyViaManyToManyQuery(req, res) {
    ...
    return countQuery.then(function(count) {
        return query.then(_getManyResponse(res, embed, count, limit, offset));
    }).catch(routeUtils._transformKnexError);
}
 ...
 * @return {Function}
 */
function _getOneResponse(res, resource, embed) {
 ...
 * @return {Function}
 */
function _getManyResponse(res, embed, count, limit, offset) {
    return function(rows) {
